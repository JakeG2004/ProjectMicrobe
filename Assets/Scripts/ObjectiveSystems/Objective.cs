...
public class Objective
{
    ...
    // Invoked when objective progress changes
    ...
    // Check the function for complete, set the bool and call the event if so
    ...
    // Add integer progress to the objective
    ...
    // Get the string that is the current status text
