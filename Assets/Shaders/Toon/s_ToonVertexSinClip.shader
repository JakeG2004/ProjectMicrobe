Shader "Landon/Toon/Texture, Vertex Sin, Clip" {
	Properties {
	...
	SubShader {
		...
		// #pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha fullforwardshadows addshadow nolightmap nofog nolppv
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha fullforwardshadows addshadow nolightmap nolppv
