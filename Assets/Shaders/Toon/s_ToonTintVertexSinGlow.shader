Shader "Landon/Toon/Tint Mask/Vertex Sin, Glow" {
    ...
    SubShader {
        ...
        fixed4 _SColor;
        sampler2D _Ramp;
		half4 _TintR, _TintG, _TintB, _TintA;
        ENDCG
        ...
        void surf(Input input, inout SurfaceOutputCustom output) {
            // Shader Properties Sampling
            float4 tex = TCP2_TEX2D_SAMPLE(_MainTex, _MainTex, input.texcoord0.xy).rgba;
            ...
            output.Albedo = tex.r * _TintR.rgb + tex.g * _TintG.rgb + tex.b * _TintB.rgb;
            output.Alpha = 1;

            output.Emission = (1-tex.a) * _TintA.rgb * 2;
        }
